...
class RealTimeDetectionActivity : AppCompatActivity() {
    ...
    private fun parseDetections(output: Array<Array<FloatArray>>): List<DetectorFragment.DetectionResult> {
        val results = mutableListOf<DetectorFragment.DetectionResult>()
        ...
        for (i in 0 until numAnchors) {
            ...
            results.add(DetectorFragment.DetectionResult(
    ...
    private fun nonMaxSuppression(detections: List<DetectorFragment.DetectionResult>, iouThreshold: Float): List<DetectorFragment.DetectionResult> {
        val sorted = detections.sortedByDescending { it.score }.toMutableList()
        val result = mutableListOf<DetectorFragment.DetectionResult>()
