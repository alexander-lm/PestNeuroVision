...
class OverlayView @JvmOverloads constructor(
    ...
    private var detections: List<DetectorFragment.DetectionResult> = emptyList()
    ...
    fun setDetections(results: List<DetectorFragment.DetectionResult>, modelInputSize: Int) {
        detections = results
